...
export function PainelResumoOperacional({ autos }: PropsPainelResumoOperacional) {
  ...
  return (
    <section aria-label="Resumo operacional" data-testid="resumo-operacional">
      <h2>Resumo operacional</h2>
      <p data-testid="rotulo-semana-padrao">
        Todas as contagens abaixo consideram a <strong>{ROTULO_SEMANA_PADRAO}</strong>.
      </p>

      <table data-testid="tabela-por-servico">
        <caption>Por Serviço</caption>
        <thead>
          <tr>
      ...
      <table data-testid="tabela-total-autos">
        <caption>Total do Autos</caption>
        <tbody>
          <tr>
      ...
      <table data-testid="tabela-faixas">
        <caption>Por faixa de horário — total do Autos</caption>
        <thead>
          <tr>
