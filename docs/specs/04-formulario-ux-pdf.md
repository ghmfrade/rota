...
- Aviso obrigatório antes de prosseguir:
  ...
  > "Este documento não parte de um JSON anterior. Sem ele, não haverá preservação de identidade das entidades para comparação entre versões (o Comparador tratará tudo como novo)."
...
| Empresa         | Idem.                                                                                                                                                                                             |
| Tipo            | Idem. Trocar o tipo com Serviços já cadastrados que violem a tipificação do novo tipo → bloqueio/alerta (regra: Spec 03 §10.4).                                                                   |
