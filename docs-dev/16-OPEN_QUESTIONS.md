...
**Status:** **Aberta — priorização adiada pelo dono do domínio (2026-07-16).** Não bloqueia as TASK-059/060 (mapa/rota), que são independentes. Vira task quando priorizada; não nasce task agora por decisão explícita do responsável.
