...
A **TASK-077** saiu da lista: implementada em `553d1e6` e **aprovada com ressalvas** em `14-REVISOES/TASK-077-20260722.md` — espelhamento Ida↔Volta por gesto atômico de Seção (DEC-063/DEC-071); a condição da ressalva (movimento Seção↔Local sem espelho) deve ser fechada **antes da TASK-076**; ver §3 e o cabeçalho deste documento.
