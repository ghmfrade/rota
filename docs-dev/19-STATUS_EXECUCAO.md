...
A **TASK-077** saiu da lista: implementada em 2026-07-23 — espelhamento Ida↔Volta por gesto atômico de Seção (DEC-063/DEC-071); ver §3 e o cabeçalho deste documento.

| # | Task | Complex. | Observação |
|:---:|---|:---:|---|
| 2 | **076** — Ida e Volta no mesmo mapa (abas, tracejado, dois painéis) | **5** | A mais cara do backlog pendente. Assume a Volta derivada (077, entregue); preserva erro de Local extremo por sentido, sem contaminar a ocorrência válida no outro (DEC-070). |
