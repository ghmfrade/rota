...
|:---:|---|:---:|---|
| 1 | **100** — Botão "redefinir Seção": todos os pontos voltam para o ponto do serviço/sentido em edição (**DEC-080**, nova) | **2** | **Criada em 2026-07-24** (Q-058/DEC-080). **Dependência da TASK-078 cumprida** (`714028b`, aprovada na reavaliação): reusa o motor de translação `transladarSecao` com destino fixo em vez de vetor de arrasto. Botão de refresh na linha de Seção da tabela lateral, entre mover e remover; confirmação OK/Cancelar. |
