...
| 5 | **095** — Formulário de nome de Seção/Local inline na tabela, na posição de inserção (DEC-077) | **2** | Criada em 2026-07-23, independente da TASK-094 (concluída). Só UX; compõe com a tabela redesenhada (091). Sem mudança de contrato/fluxo. |
