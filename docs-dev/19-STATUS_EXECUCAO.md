...
**Atualização mais recente:** 2026-07-28 (branch `redesign`) — **TASK-115
...
parcial e a TASK-040 bloqueada**. Antes nesta data, a **TASK-114 foi concluída
e aprovada**: a implementação `13e583b` mantém “Restaurar sugestão” e “Apagar
viagem” inteiramente visíveis e clicáveis em domingo, sem alterar a posição
...
**Estado atual: 17 tasks não concluídas: 15 executáveis, a TASK-038 com bloqueio
parcial e a TASK-040 bloqueada.** Em 2026-07-28, a **TASK-115 saiu da fila**:
...
| 2 | **109** — Cópia unitária entre dias por arrasto + atalhos para dias adjacentes | **2** | Desbloqueada (DEC-084/089/092; Spec 04 §8.3 alinhada) | Sempre copia; destino em qualquer dia por arrasto; `Ctrl+←`/`Ctrl+→` sem wrap; guarda de duplicidade preservada. |
