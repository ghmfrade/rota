...
| # | Task | Complex. | Observação |
|:---:|---|:---:|---|
| — | **090** — Executor canônico/controlado da suíte completa | **3** | **Próxima prioridade operacional, sem dependências.** Canoniza `test:all:log`, porta/PID/timeout/cleanup/fingerprint e o reaproveitamento da evidência entre `implementar-task` e `revisar-aderencia`. |
