...
implementada e aprovada com ressalva impeditiva de merge**. O commit `7ac010f`
...
| 3 | **117** — Operações de dia no cabeçalho + recomposição do headway | **2** | Implementada; aprovada com ressalvas impeditivas | Suíte verde; restaurar `dialogo-opcoes-apagar`, completar E2E de feriados/composição visual e reavaliar antes do merge. |
